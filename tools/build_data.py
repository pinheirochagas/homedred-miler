...
GPX = os.path.join(ROOT, "course_v4.gpx")
...
def main():
    ...
    POIS = [
        ...
        ("Muir Beach parking lot", 37.861540, -122.575695),
        ...
        ("Cardiac Hill / water fountain", 37.89743, -122.60165),
        ...
        ("Bolinas Ridge Trailhead", 38.04616329985451, -122.77044876117509),
        ("Samuel P Taylor SP entrance", 38.0187, -122.7304),
        ("Leo T. Cronin roadside handoff", 38.00446598606687, -122.70893123134023),
        ...
        ("Bolinas Rd / Sky Oaks Rd", 37.97284597370649, -122.60507944649592),
    ...
    for name, plat, plon in POIS:
        ...
        while i < n:
            ...
            if dd < 400:
                ...
                i += 1
        # Nearby threshold crossings are one physical pass; retain its closest point.
        merged = []
        for candidate in passes:
            if merged and dist[candidate[0]] - dist[merged[-1][0]] < 1609.344:
